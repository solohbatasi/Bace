...
const navigation = computed(() => [
    ...
    { name: 'Tickets', route: 'finance.tickets.*', href: route('finance.tickets.index'), icon: 'ticket', permission: 'tickets.view|finance.view' },
    ...
    { name: 'Results', route: 'academics.results.*', href: route('academics.results.index'), icon: 'clipboard', permission: 'results.view|examinations.edit|examinations.manage|classes.manage' },
                    ...
                    <nav class="space-y-1">
                        ...
                        >
                            <svg class="size-4 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
                                ...
                                <path v-else-if="item.icon === 'ticket'" stroke-linecap="round" stroke-linejoin="round" d="M5 6h14v4a2 2 0 0 0 0 4v4H5v-4a2 2 0 0 0 0-4V6Zm5 3v6m4-6v6" />
