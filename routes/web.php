...
Route::middleware([
    ...
    Route::prefix('finance')->name('finance.')->group(function () {
        ...
        Route::post('tickets/rules', [LessonTicketController::class, 'storeRule'])->name('tickets.rules.store')->middleware('permission:tickets.add|finance.manage');
        Route::put('tickets/rules/{rule}', [LessonTicketController::class, 'updateRule'])->name('tickets.rules.update')->middleware('permission:tickets.edit|finance.manage');
        Route::delete('tickets/rules/{rule}', [LessonTicketController::class, 'destroyRule'])->name('tickets.rules.destroy')->middleware('permission:tickets.delete|finance.manage');
