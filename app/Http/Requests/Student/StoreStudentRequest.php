...
class StoreStudentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'subcourse_id' => ['nullable', 'integer', Rule::exists('courses', 'id')],
            ...
            'additional_courses.*.course_id' => ['required_with:additional_courses', 'integer', Rule::exists('courses', 'id')],
            'additional_courses.*.subcourse_id' => ['nullable', 'integer', Rule::exists('courses', 'id')],
